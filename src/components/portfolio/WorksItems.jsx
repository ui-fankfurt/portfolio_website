    ...
    return (
        <div className="work__card" key={item.id}>
            ...
            <div className={toggleState === 3 ? 
                        "work__modal active-modal" : "work__modal"}>
                        <div className="work__modal-content">
                            ...
                            <ul className="work__modal-services grid">
                                <li className="work__modal-service">
                                    ...
                                    <p className="work__modal-info">I build machine learning 
                                    models that contributes to effective business decisions.</p>
                                </li>

                                <li className="work__modal-service">
                                    <i className="uil uil-check-circle work__modal-icon"></i>
                                    <p className="work__modal-info">Fine-tuning Large Language 
                                    Models</p>
                                </li>

                                <li className="work__modal-service">
                                    <i className="uil uil-check-circle work__modal-icon"></i>
                                    <p className="work__modal-info">Building advanced computer 
                                    vision models</p>
                                </li>
                            </ul>
                        </div>
