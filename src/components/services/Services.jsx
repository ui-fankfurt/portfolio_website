        ...
        <section className="services section" id="experience">
            ...
            <div className="services__container container grid">
                ...
                <div className="services__content">
                    <div>
                        <i className="uil uil-web-grid services__icon"></i>
                        <h3 className="services__title">AI Research Engineer, <br />Bosch</h3>
                    </div>
                    ...
                    <div className={toggleState === 4 ? "services__modal active-modal" : "services__modal"}>
                        ...
                        <h3 className="services__modal-title">AI Research Engineer</h3>
                        <p className="services__modal-description">Bosch</p>

                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Conducted research on advanced AI techniques.</p>
                            </li>

                            <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Developed innovative AI solutions for Bosch products.</p>
                            </li>

                            <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Collaborated with cross-functional teams to integrate AI capabilities.</p>
                            </li>
                        </ul>
                        </div>
                    </div>
